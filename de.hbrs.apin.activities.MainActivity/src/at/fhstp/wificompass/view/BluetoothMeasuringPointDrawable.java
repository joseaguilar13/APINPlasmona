...
import at.fhstp.wificompass.model.BluetoothScanResult;
 ...
 */
public class BluetoothMeasuringPointDrawable extends MultiTouchDrawable {
	 ...
	 * @uml.associationEnd
	 */
	protected BluetoothScanResult scanResult;
	...
	public BluetoothMeasuringPointDrawable(Context ctx, MultiTouchDrawable superDrawable, BluetoothScanResult scanResult) {
	...
	protected void init() {
		icon = (BitmapDrawable) ctx.getResources().getDrawable(R.drawable.footprint_2);
	...
	public void onDelete() {
		try {
			...
			databaseHelper.getDao(BluetoothScanResult.class).delete(scanResult);
