 ...
 */
public class UserWiFiDrawable extends MultiTouchDrawable {
	...
	public UserWiFiDrawable(Context ctx,MultiTouchDrawable superDrawable) {
		super(ctx,superDrawable);
		init();
	}

	protected void init() {
		icon = (BitmapDrawable) ctx.getResources().getDrawable(R.drawable.wifiicon);
